...
#define RuleID 0
#define EventDeviceID 2
#define RuleIndicator 6
#define RuleThreshold 7
#define ActionDeviceID 8
#define ActionValue 9
#define Priority 16

#define StatusEvent 0
#define StatusAction 1
#define StatusPre_s 2
#define StatusNext_s 3

#endif /*__RULEDEFINE_H__*/